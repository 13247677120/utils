...
public class MyCommentGenerator extends DefaultCommentGenerator {
	...
	public void addComment(XmlElement xmlElement) {
		 ...
		 * //$NON-NLS-1$ sb.append(MergeConstants.NEW_ELEMENT_TAG);
	...
	public void addFieldComment(Field field, IntrospectedTable introspectedTable) {
		...
		field.addJavaDocLine("/**"); //$NON-NLS-1$
		if ("orderByClause".endsWith(field.getName())) {
			field.addJavaDocLine(" * 排序");
		} else if ("distinct".endsWith(field.getName())) {
			field.addJavaDocLine(" * 去重");
		} else if ("oredCriteria".endsWith(field.getName())) {
